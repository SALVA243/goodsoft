...
const content_data: ContentType = {
  desc_1: (
    <>
      Our mission is to make the world a better place for everyone. Everyone has
      their rights equally and we want to make sure that people can get food,
      education, treatment and accommodation for everyone who is living in
      poverty.
    </>
  ),
  desc_2: (
    <>
      The great journey to end poverty for good begins with a child. Due to
      natural disasters and man made disasters so many people are suffering so
      help to recover them.
    </>
  ),
  desc_3: (
    <>
  ...
  earning_doner: [
    ...
    { title: "Total Doner:", earning: "250+" },
  ],
};

const { desc_1, desc_2, desc_3, tags, earning_doner } = content_data;
