"use client";
import Produits_data from "@/data/ProduitsData";
import Image from "next/image";
import Link from "next/link";
import { useState } from "react";

const ProduitsComptabilite = () => {
  const [currentPage, setCurrentPage] = useState(1);

  const blogs = Produits_data.filter((items) => items.type === "comptabilite");
...
export default ProduitsComptabilite;
