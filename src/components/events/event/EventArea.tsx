...
const EventArea = () => {
  ...
  const blogs = Produits.filter((items) => items.page === "inner_page");
      ...
      <div className="container">
        <div className="row justify-content-center">
          {currentItems.map((item) => (
            <div key={item.id} className="col-xl-4 col-md-6 py-60">
              <div className="image">
              ...
              <div className="content my-10">
                ...
                <p>{item.desc}</p>
                <Link className="event-btn" href={`/event-details/${item.id} `}>
