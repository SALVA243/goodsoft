...
const Brand = ({ style }: any) => {
  ...
  return (
    <>
      <div className="client-area-three pb-90 rel z-1 mt-50">
        <div className="section-title text-center mb-55">
          <span className="section-title__subtitle mb-10">Nos Clients</span>
          <p>
            Ces entreprises nous ont toutes fait <span>confiance</span> et
            n&apos;ont jamais regretté leur choix.
          </p>
        </div>
        <div
          className={`client-logo-area ${
            style ? "py-75" : "bgc-lighter py-30"
          }`}
          style={{
            backgroundImage: `${
